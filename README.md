...
The app allows users to view Pokémons, search them and add them to their favourites list.
...
* The user can add the searched Pokémons to their favourites list as the favorite button is available on each card.
...
* A Pokémon can be removed from the user's Favourites list by unchecking the Add to Favorite button on a Pokémon's card in the Home Fragment, Search Fragment, Info Fragment or even the Favorite Fragment itself.
